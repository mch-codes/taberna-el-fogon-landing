  ...
  return (
    <section id="reservas" className="px-4 pb-14 md:pb-20 scroll-mt-16">
      <div className="max-w-5xl mx-auto rounded-3xl bg-pizarra text-papel px-6 py-14 md:py-20 text-center">
        ...
        <p className="mt-4 text-papel/80 max-w-md mx-auto">{t.reservas.texto}</p>
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-5">
          <a
            ...
            className="inline-flex items-center gap-2 bg-verde hover:bg-verde-700 transition-colors text-white font-semibold px-6 py-3.5 rounded-xl"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-papel font-semibold underline underline-offset-4 decoration-papel/40 hover:decoration-papel"
          >
